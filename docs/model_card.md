...
Rede neural MLP treinada para prever cancelamento de clientes (churn) em uma operadora de telecomunicações. O modelo classifica clientes com risco de cancelamento para que a empresa possa tomar ações de retenção.
